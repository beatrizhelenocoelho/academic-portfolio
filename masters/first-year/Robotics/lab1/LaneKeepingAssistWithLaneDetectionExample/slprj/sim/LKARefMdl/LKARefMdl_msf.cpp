...
#define S_FUNCTION_NAME LKARefMdl_msf
#endif
...
false ) ; ssSetInputPortSampleTime ( S , 0 , 0.05 ) ;
...
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "m" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetInputPortUnit ( S , 1 , unitIdReg ) ;
#endif
} ssSetInputPortDirectFeedThrough ( S , 1 , 1 ) ;
ssSetInputPortRequiredContiguous ( S , 1 , 1 ) ; ssSetInputPortOptimOpts ( S
, 1 , SS_NOT_REUSABLE_AND_LOCAL ) ; ssSetInputPortOverWritable ( S , 1 ,
false ) ; ssSetInputPortSampleTime ( S , 1 , 0.05 ) ;
...
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "rad" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetInputPortUnit ( S , 2 , unitIdReg ) ;
#endif
} ssSetInputPortDirectFeedThrough ( S , 2 , 1 ) ;
ssSetInputPortRequiredContiguous ( S , 2 , 1 ) ; ssSetInputPortOptimOpts ( S
, 2 , SS_NOT_REUSABLE_AND_LOCAL ) ; ssSetInputPortOverWritable ( S , 2 ,
false ) ; ssSetInputPortSampleTime ( S , 2 , 0.05 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 3 , 0.05 ) ;
ssSetInputPortOffsetTime ( S , 3 , 0.0 ) ; if ( !
ssSetInputPortMatrixDimensions ( S , 4 , 1 , 1 ) ) return ;
ssSetInputPortDimensionsMode ( S , 4 , FIXED_DIMS_MODE ) ;
ssSetInputPortFrameData ( S , 4 , FRAME_NO ) ; if ( ssGetSimMode ( S ) !=
SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
{ DTypeId dataTypeIdReg ; ssRegisterTypeFromNamedObject ( S , "LaneSensor" ,
...
false ) ; ssSetInputPortSampleTime ( S , 4 , 0.05 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 5 , 0.05 ) ;
...
false ) ; ssSetInputPortSampleTime ( S , 6 , 0.05 ) ;
...
#endif
} ssSetOutputPortSampleTime ( S , 0 , 0.05 ) ; ssSetOutputPortOffsetTime ( S
...
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "rad" , & unitIdReg ) ; if ( unitIdReg == INVALID_UNIT_ID ) return ; ssSetOutputPortUnit ( S , 1 , unitIdReg ) ;
#endif
} ssSetOutputPortSampleTime ( S , 1 , 0.05 ) ; ssSetOutputPortOffsetTime ( S
...
mr_LKARefMdl_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S , 2 ) ;
...
SS_SIMMODE_SIZES_CALL_ONLY ) { int_T retVal = 1 ; mr_LKARefMdl_MdlInfoRegFcn
( S , const_cast < char * > ( "LKARefMdl" ) , & retVal ) ; if ( ! retVal )
return ; }
#endif
#if SS_SFCN_FOR_SIM
...
( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( c5e02tcafze ) ) )
...
ssSetSampleTime ( S , 0 , 0.05 ) ; ssSetOffsetTime ( S , 0 , 0 ) ;
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { c5e02tcafze * dw = ( c5e02tcafze * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid ( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } c1o4boxk4f ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) , slmrGetTopTidFromMdlRefChildTid ( S , 1 , true ) , & ( dw -> rtm ) , & ( dw -> rtb ) , & ( dw -> rtdw ) , sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & ( dw -> rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } pi2hal0oyf ( & ( dw -> rtm ) , & ( dw -> rtdw ) ) ; }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { c5e02tcafze * dw = ( c5e02tcafze * ) ssGetDWork ( S , 0 )
; boolean_T const * i_dpkdklqpib = ( boolean_T * ) ssGetInputPortSignal ( S ,
0 ) ; real32_T const * i_oqtl0ico1r = ( real32_T * ) ssGetInputPortSignal ( S
, 1 ) ; real_T const * i_hlnl5o3axd = ( real_T * ) ssGetInputPortSignal ( S ,
2 ) ; LaneSensor const * i_d5t0vjkc1g = ( LaneSensor * ) ssGetInputPortSignal
( S , 4 ) ; boolean_T const * i_brawslqpxw = ( boolean_T * )
ssGetInputPortSignal ( S , 5 ) ; boolean_T const * i_bz5b1hvptl = ( boolean_T
* ) ssGetInputPortSignal ( S , 6 ) ; boolean_T * o_B_6_1 = ( boolean_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_6_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; if ( tid == PARAMETER_TUNING_TID ) { } if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { LKARefMdl ( & ( dw -> rtm ) , i_dpkdklqpib , i_oqtl0ico1r , i_hlnl5o3axd , i_d5t0vjkc1g , i_brawslqpxw , i_bz5b1hvptl , o_B_6_1 , o_B_6_2 , & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { c5e02tcafze * dw = ( c5e02tcafze * ) ssGetDWork ( S , 0 ) ; i30xuqpc24 ( & ( dw -> rtb ) , & ( dw -> rtdw ) ) ; return ; } static void mdlTerminate ( SimStruct * S ) { c5e02tcafze * dw = ( c5e02tcafze * ) ssGetDWork ( S , 0 ) ; cpebt4uidm ( & ( dw -> rtm ) ) ; return ; }
#define MDL_CLEANUP_RUNTIME_RESOURCES
static void mdlCleanupRuntimeResources ( SimStruct * S ) { c5e02tcafze * dw =
( c5e02tcafze * ) ssGetDWork ( S , 0 ) ; dmps3x051h ( & ( dw -> rtm ) , & ( dw
-> rtdw ) ) ; }
...
mdlrefDW = mr_LKARefMdl_GetDWork ( static_cast < const c5e02tcafze * > ( ssGetDWork ( S , 0 ) ) ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data = mr_LKARefMdl_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber ( ss , 0 , 2 , data ) ; } ; mxSetFieldByNumber ( ss , 0 , 3 , mxCreateDoubleScalar ( ( double ) ssGetTNext ( S ) ) ) ; mxSetFieldByNumber ( ss , 0 , 4 , mxCreateDoubleScalar ( ( double ) ssGetTNextTid ( S ) ) ) ; return ss ; }
#if !defined(MDL_SIM_STATE)
#define MDL_SIM_STATE
#endif
static void mdlSetSimState ( SimStruct * S , const mxArray * ss ) {
mr_LKARefMdl_SetDWork ( static_cast < c5e02tcafze * > ( ssGetDWork ( S , 0 )
) , mxGetFieldByNumber ( ss , 0 , 1 ) ) ; ssSetTNext ( S , ( time_T )
mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 3 ) ) ) ; ssSetTNextTid ( S , ( int_T ) mxGetScalar ( mxGetFieldByNumber ( ss , 0 , 4 ) ) ) ; }
