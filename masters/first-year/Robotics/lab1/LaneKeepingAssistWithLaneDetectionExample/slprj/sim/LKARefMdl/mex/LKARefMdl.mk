###########################################################################
## Makefile generated for component 'LKARefMdl'. 
## 
## Makefile     : LKARefMdl.mk
## Generated on : Thu Dec 04 23:14:59 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LKARefMdl_msf.mexw64
...
PRODUCT_NAME              = LKARefMdl
MAKEFILE                  = LKARefMdl.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2025b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2025b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/diogo/OneDrive/Documentos/MATLAB/Examples/R2025b/autonomous_control/LaneKeepingAssistWithLaneDetectionExample
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
MODELREF_LINK_RSPFILE     = LKARefMdl_ref.rsp
COMPILER_COMMAND_FILE     = LKARefMdl_comp.rsp
CMD_FILE                  = LKARefMdl.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LKARefMdl_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=LKARefMdl -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/LKARefMdl/LKARefMdl_msf.cpp $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = LKARefMdl_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/diogo/OneDrive/Documentos/MATLAB/Examples/R2025b/autonomous_control/LaneKeepingAssistWithLaneDetectionExample/slprj/sim/LKARefMdl/LKARefMdllib.lib
...
SYSTEM_LIBS = -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -L"C:/Program Files/MATLAB/R2025b/extern/lib/win64/mingw64" -llibmwipp -llibfixedpoint -llibmwmathutil -llibmwsl_AsyncioQueue -lsf_runtime -llibmwslexec_simlog -llibmwcoder_ToAsyncQueueTgtAppSvc -llibmwsl_simtarget_instrumentation -llibmwsl_simtarget_core -llibmwstringutil -llibemlrt -llibmx -llibmex -llibMatlabDataArray
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS)
	...
	$(CPP_LD) $(CPP_SHAREDLIB_LDFLAGS) -o $(PRODUCT) @$(CMD_FILE) -Wl,--start-group @$(MODELREF_LINK_RSPFILE) $(LIBS) -Wl,--end-group $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
LKARefMdl_msf.obj : $(START_DIR)/slprj/sim/LKARefMdl/LKARefMdl_msf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
