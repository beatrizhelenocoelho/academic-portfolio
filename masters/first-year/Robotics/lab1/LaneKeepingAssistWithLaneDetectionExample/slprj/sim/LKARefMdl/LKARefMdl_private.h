#ifndef LKARefMdl_private_h_
#define LKARefMdl_private_h_
#include "rtwtypes.h"
...
extern "C" const char_T * rt_GetMatSignalLoggingFileName ( void ) ; extern
"C" const char_T * rt_GetMatSigLogSelectorFileName ( void ) ; extern "C" void
* rt_GetOSigstreamManager ( void ) ; extern "C" void * *
rt_GetOSigstreamManagerAddr ( void ) ; extern "C" void * rt_slioCatalogue ( void
) ; extern "C" void * * rt_slioCatalogueAddr ( void ) ; extern "C" void
rt_ssSet_slErrMsg ( void * S , void * diag ) ; extern "C" void
rt_ssReportDiagnosticAsWarning ( void * S , void * diag ) ; extern "C" void
rt_ssReportDiagnosticAsInfo ( void * S , void * diag ) ; extern "C" const
char_T * rt_CreateFullPathToTop ( const char_T * toppath , const char_T *
subpath ) ; extern "C" boolean_T slIsRapidAcceleratorSimulating ( void ) ;
extern "C" void rt_RAccelReplaceFromFilename ( SimStruct * S , const char_T *
blockpath , char_T * fileNam ) ; extern "C" void rt_RAccelReplaceToFilename ( SimStruct * S , const char_T * blockpath , char_T * fileNam ) ; extern "C" void slsaCacheDWorkPointerForSimTargetOP ( void * ss , void * * ptr ) ; extern "C" void slsaCacheDWorkDataForSimTargetOP ( void * ss , void * ptr , unsigned int sizeInBytes , bool restoreRequiresSolverReset ) ; extern "C" void slsaSaveRawMemoryForSimTargetOP ( void * ss , const char_T * key , void * * ptr , unsigned int sizeInBytes , void * ( * customOPSaveFcn ) ( void * dworkPtr , unsigned int * sizeInBytes ) , void ( * customOPRestoreFcn ) ( void * dworkPtr , const void * data , unsigned int sizeInBytes ) ) ; extern void * gblLoggingInterval ;
