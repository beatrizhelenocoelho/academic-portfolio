...
% Control Toolbox(TM).
% # Test the control system in a closed-loop Simulink(R) model using synthetic
...
% decisions when the data from the sensor is invalid or outside a range. This
...
% Embedded Coder(R) software. To check if you have access to Embedded Coder,
% run:
%
...
% compiled, and executed for the |LKARefMdl| model. This allows
