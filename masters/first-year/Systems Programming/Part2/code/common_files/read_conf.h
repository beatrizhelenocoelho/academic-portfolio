...
// ----------------------------------------------------------------------------
// Reads network-related settings from a libconfig configuration file.
// Depending on usage, it can read server IP and ports or only ports.
// Prints an error message if required settings are missing.
//
...
//
// Parameters:
//   cfg        - pointer to initialized libconfig configuration object
//   ip_server - pointer to store server IP address string (can be NULL)
//   pub_port  - pointer to store public port string
//   port      - pointer to store private/local port string
//
// Returns:
//   1 on success
//   0 on failure
