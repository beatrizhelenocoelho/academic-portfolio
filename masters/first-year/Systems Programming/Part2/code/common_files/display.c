...
/////////////////////////////////////////
int initialize_SDL_server(int window_size, SDL_Window **window, SDL_Renderer **renderer, SDL_Color color)
{
    ...
    *window = SDL_CreateWindow("Universe-Server",
...
int initialize_SDL_client(int window_size, SDL_Window **window, SDL_Renderer **renderer, SDL_Color color)
{
   if (SDL_Init(SDL_INIT_VIDEO | SDL_INIT_TIMER) != 0) {
        printf("SDL_Init Error: %s\n", SDL_GetError());
        return 0;
    ...
    *window = SDL_CreateWindow("Trash-Ship",
                                   SDL_WINDOWPOS_CENTERED,
                                   SDL_WINDOWPOS_CENTERED,
                                   window_size ,
                                   window_size ,
...
/////////////////////////////////////////
///Draw closing screen on client/server when server closes correct
/////////////////////////////////////////
void draw_server_close(SDL_Renderer *renderer, TTF_Font *font, int window_size, SDL_Color bg0, int user){

        SDL_Color red = {255, 0, 0, 255};
    const char *msg = " Exiting GAME ";
    if (user == 1){
     msg = " Exiting GAME - Server Close";
...
/////////////////////////////////////////
///Draw closing screen on client/server when world collapses
/////////////////////////////////////////
void draw_world_colapse_close(SDL_Renderer *renderer, TTF_Font *font, int window_size, SDL_Color bg0, int user){
        SDL_Color red = {255, 0, 0, 255};
...
/////////////////////////////////////////
///Draw closing screen on client when server closes incorrect
/////////////////////////////////////////
void draw_server_collapsed(SDL_Renderer *renderer, TTF_Font *font, int window_size, SDL_Color bg0){
        SDL_Color red = {255, 0, 0, 255};
        const char *msg = "Server Down, impossible to connet. Quitting game";
