...
- OCR blocks analysed: **62**
- Blocks with high OCR/speech agreement: **13**
- Blocks with related/medium agreement: **0**
- Blocks with low conflict: **5**
- Blocks marked for manual review: **46**
- Main final themes: **Other/Unknown, Saúde, Economia/Proteção Social, Governo/Partidos, Ambiente/Meteorologia/Proteção Civil**
