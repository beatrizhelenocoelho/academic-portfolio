...
- OCR blocks analysed: **37**
- Blocks with high OCR/speech agreement: **0**
- Blocks with related/medium agreement: **0**
- Blocks with low conflict: **3**
- Blocks marked for manual review: **35**
- Main final themes: **Other/Unknown, Internacional, Justiça/Segurança, Greves/Trabalho, Governo/Partidos**
