...
- OCR blocks analysed: **61**
- Blocks with high OCR/speech agreement: **2**
- Blocks with related/medium agreement: **1**
- Blocks with low conflict: **10**
- Blocks marked for manual review: **58**
- Main final themes: **Other/Unknown, Greves/Trabalho, Governo/Partidos, Economia/Proteção Social, Educação**
