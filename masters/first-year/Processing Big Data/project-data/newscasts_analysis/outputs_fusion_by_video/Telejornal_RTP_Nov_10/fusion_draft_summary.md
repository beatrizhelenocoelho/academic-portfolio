...
- OCR blocks analysed: **48**
- Blocks with high OCR/speech agreement: **4**
- Blocks with related/medium agreement: **1**
- Blocks with low conflict: **7**
- Blocks marked for manual review: **43**
- Main final themes: **Other/Unknown, Eleições/Campanha, Governo/Partidos, Internacional, Justiça/Segurança**
