...
- OCR blocks analysed: **57**
- Blocks with high OCR/speech agreement: **6**
- Blocks with related/medium agreement: **2**
- Blocks with low conflict: **4**
- Blocks marked for manual review: **49**
- Main final themes: **Eleições/Campanha, Other/Unknown, Justiça/Segurança, Saúde, Sondagens**
