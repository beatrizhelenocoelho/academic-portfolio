...
- OCR blocks analysed: **45**
- Blocks with high OCR/speech agreement: **4**
- Blocks with related/medium agreement: **0**
- Blocks with low conflict: **6**
- Blocks marked for manual review: **40**
- Main final themes: **Other/Unknown, Governo/Partidos, Internacional, Greves/Trabalho, Saúde**
