...
signal sig_out_regP : std_logic_vector((PORT_WIDTH - 1) downto 0) := (others => '0');
...
inst_btn : btn_ctrl port map (clk => clk_i, rst => '0', btnI => sig_out_reg, btnO => sig_out_regP);
SIGNAL_O <= sig_out_regP;
